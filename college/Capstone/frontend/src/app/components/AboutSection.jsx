...
export default function AboutSection() {
  ...
  // Data tim Grapholyze (bisa kamu ubah kapan aja)
  const team = [
  ...
  return (
    <section id="about" className="bg-white text-gray-800">
          ...
          {[
            {
              ...
              desc: "Analisis visual dengan akurasi tinggi",
              color: "bg-indigo-200",
              icon: <Cpu size={32} className="text-indigo-700" />,
            },
            {
              title: "Deep Learning",
              desc: "Neural networks untuk pattern recognition",
              color: "bg-green-200",
              icon: <Brain size={32} className="text-green-700" />,
            },
            {
              title: "Rekayasa Perangkat Lunak",
              desc: "Aplikasi Web responsif dan intuitif",
              color: "bg-purple-200",
              icon: <Code2 size={32} className="text-purple-700" />,
            },
            {
              title: "Machine Learning",
              desc: "Algoritma pembelajaran berkelanjutan",
              color: "bg-violet-200",
              icon: <Network size={32} className="text-violet-700" />,
            },
          ].map((tech, i) => (
            <div key={i} className="flex flex-col items-center text-center">
      ...
      <div className="bg-indigo-900 text-white text-center py-16">
        ...
        <button onClick={() => router.push("homeanalisis")} className="bg-white text-indigo-600 font-semibold text-lg px-8 py-3 rounded-xl shadow hover:bg-gray-100 transition-all duration-300">
          Mulai Analisis
        </button>
      </div>
    </section>
