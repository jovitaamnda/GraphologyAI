    ...
    <div className="min-h-screen bg-[#7B61FF] flex flex-col items-center">
      ...
      <div className="bg-white mt-16 p-10 rounded-2xl shadow-xl w-[400px] text-center">
        ...
        <div className="flex mb-6 rounded-lg overflow-hidden">
          <button onClick={() => setIsLogin(true)} className={`w-1/2 py-2 font-medium transition-all ${isLogin ? "bg-[#7B61FF] text-white" : "bg-gray-100 text-gray-600 hover:bg-gray-200"}`}>
            Login
          </button>
          <button onClick={() => setIsLogin(false)} className={`w-1/2 py-2 font-medium transition-all ${!isLogin ? "bg-[#7B61FF] text-white" : "bg-gray-100 text-gray-600 hover:bg-gray-200"}`}>
            Register
          </button>
        </div>
